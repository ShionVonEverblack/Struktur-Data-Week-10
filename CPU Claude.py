# Deskripsi:
#   Program ini mensimulasikan penjadwalan job pada CPU.
#   Setiap iterasi loop = satu time slice untuk CPU.
#   Job memiliki priority (-20 tertinggi, 19 terendah) dan length (1-100).
#   CPU selalu mengerjakan job dengan priority tertinggi (angka terkecil).
#   Job bersifat non-preemptive (tidak bisa diinterupsi setelah dijadwalkan).
...
def main():
    ...
    print("=" * 60)
    print()
    print("Format command yang tersedia:")
    ...
    print("  - Job bersifat non-preemptive (tidak bisa diinterupsi)")
    print()
